    ...
    <div id="main-content">
        ...
        <section id="projects" class="projects" aria-label="Projects">
            ...
            <div class="projects-list">
                ...
                <div class="project-card card">
                    <strong>Personal Portfolio Website <span class="project-role">| Full-Stack Developer</span></strong>
                    <ul>
                        <li>Modern, responsive portfolio website showcasing skills, projects, and professional experience.</li>
                        <li>Features: Responsive design, interactive animations, contact form, authentication system.</li>
                        <li>Technologies: HTML, CSS, JavaScript, PHP, MySQL, modern web standards.</li>
                    </ul>
                </div>
            </div>
        </section>
