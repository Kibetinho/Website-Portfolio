        ...
        <div class="auth-container">
            ...
            <form id="register-form" class="auth-form" autocomplete="off" method="post" action="">
                <div class="form-group">
                    ...
                    <input type="text" id="fullname" name="fullname" required minlength="2" placeholder="Your full name" value="<?php echo htmlspecialchars($_POST['fullname'] ?? '', ENT_QUOTES); ?>">
                    <div class="error-message" id="fullname-error"></div>
                </div>
                <div class="form-group">
                    <label for="email">Email Address</label>
                    <input type="email" id="email" name="email" required placeholder="you@example.com" value="<?php echo htmlspecialchars($_POST['email'] ?? '', ENT_QUOTES); ?>">
                    <div class="error-message" id="email-error"></div>
                </div>
                <div class="form-group">
                    <label for="phone">Phone Number</label>
                    <input type="tel" id="phone" name="phone" required pattern="[0-9]{10,15}" placeholder="e.g. 0712345678" value="<?php echo htmlspecialchars($_POST['phone'] ?? '', ENT_QUOTES); ?>">
